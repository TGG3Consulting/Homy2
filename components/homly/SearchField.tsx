...
export default function SearchField({ onTypingChange, accentColor = { r: 139, g: 108, b: 255 }, isLightBg = false }: SearchFieldProps) {
  const { t, lang } = useT();
  ...
  const handleSubmit = (e?: React.FormEvent | null, promptValue?: string) => {
    e?.preventDefault();
