  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2 pb-4 border-b" style={{ borderColor: "rgba(200,196,188,0.25)" }}>
        <div className="w-7 h-7 rounded-full flex items-center justify-center" style={{ backgroundColor: "rgba(10, 96, 69,0.1)" }}>
        ...
        >
          <input
            ...
            onFocus={(e) => {
              ...
              e.currentTarget.style.boxShadow = "0 0 0 3px rgba(10, 96, 69,0.05)";
            }}
            onBlur={(e) => {
          ...
          <button
            ...
            style={{
              backgroundColor: input.trim() ? "#0A6045" : "transparent",
