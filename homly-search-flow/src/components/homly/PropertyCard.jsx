...
const accent = "rgb(139, 108, 255)";
const accentLight = "rgba(139, 108, 255, 0.08)";
    ...
    <div
      ...
      style={{
        ...
        boxShadow: isSelected
          ? "0 8px 32px rgba(139, 108, 255, 0.08), 0 0 0 1px rgba(139, 108, 255, 0.12)"
          : isTop
            ? "0 4px 20px rgba(139, 108, 255, 0.04)"
    ...
    >
      ...
      >
        <button
          ...
          style={{
            backgroundColor: isTop ? accent : accentLight,
