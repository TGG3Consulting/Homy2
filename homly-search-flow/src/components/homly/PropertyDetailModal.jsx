          ...
          <div className="overflow-y-auto px-7 py-7 space-y-5 min-w-0" style={{ minHeight: 0 }}>
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex flex-col items-end gap-1.5">
                <span className="text-[28px] font-body font-bold tracking-tight" style={{ color: "#8B6CFF" }}>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {property.is_top_choice && <Badge icon={Star} label="Homly's top choice" color="#8B6CFF" bgColor="rgba(139,108,255,0.08)" />}
            ...
            >
              <div className="flex items-center gap-2">
                <Bed size={15} style={{ color: "#8B6CFF" }} />
                <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-2xl p-4" style={{ backgroundColor: "rgba(139,108,255,0.04)", border: "1px solid rgba(139,108,255,0.1)" }}>
                <h4 className="text-[11px] font-semibold font-body uppercase tracking-wider mb-2.5" style={{ color: "#8B6CFF" }}>Advantages</h4>
                <ul className="space-y-2">
                  {property.recommendation_reasons?.map((r, i) => (
                    <li key={i} className="flex items-start gap-1.5">
                      <CheckCircle size={12} className="flex-shrink-0 mt-[2px]" style={{ color: "#8B6CFF" }} />
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "rgba(139,108,255,0.1)" }}>
