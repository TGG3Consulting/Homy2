  ...
  return (
    ...
    >
      ...
      <div className="mx-5 mt-3 mb-1 flex items-center gap-3 py-3 px-3 rounded-xl" style={{ backgroundColor: "rgba(255,255,255,0.4)" }}>
        <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "rgba(139,108,255,0.1)" }}>
        ...
        <button className="flex-shrink-0 inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-[11px] font-semibold font-body transition-all duration-200 hover:shadow-sm" style={{ backgroundColor: "#8B6CFF", color: "#FFF" }}>
          <Phone size={10} />
          Contact
        </button>
      </div>
      ...
      <div className="px-5 py-4 border-t" style={{ borderColor: "rgba(200, 196, 188, 0.3)" }}>
        <form onSubmit={handleSubmit} className="relative">
          <input
            ...
            placeholder="Ask Homly to refine…"
            className="
