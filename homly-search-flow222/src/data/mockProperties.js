const mockProperties = [
  {
    ...
    virtual_tour: {
      ...
      rooms: [
        {
          id: "living-room",
          name: { en: "Living room", ru: "Гостиная", hy: "Հյուրասենյակ" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/1fa7dc336_generated_image.png",
          hotspots: [
            { target_room_id: "kitchen", x: 0.62, y: 0.48 },
            { target_room_id: "hallway", x: 0.38, y: 0.48 },
            { target_room_id: "balcony", x: 0.15, y: 0.50 }
          ]
        },
        {
          id: "kitchen",
          name: { en: "Kitchen", ru: "Кухня", hy: "Խոհանոց" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/72577ee00_generated_image.png",
          hotspots: [
            { target_room_id: "living-room", x: 0.38, y: 0.48 }
          ]
        },
        {
          id: "bedroom-1",
          name: { en: "Master bedroom", ru: "Главная спальня", hy: "Գլխավոր ննջասենյակ" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/7a8e5b5ba_generated_image.png",
          hotspots: [
            { target_room_id: "hallway", x: 0.25, y: 0.50 }
          ]
        },
        {
          id: "bedroom-2",
          name: { en: "Bedroom 2", ru: "Спальня 2", hy: "Ննջասենյակ 2" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/7a8e2d670_generated_image.png",
          hotspots: [
            { target_room_id: "hallway", x: 0.75, y: 0.50 },
            { target_room_id: "bedroom-3", x: 0.50, y: 0.40 }
          ]
        },
        {
          id: "bedroom-3",
          name: { en: "Bedroom 3", ru: "Спальня 3", hy: "Ննջասենյակ 3" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/dcbd533ec_generated_image.png",
          hotspots: [
            { target_room_id: "bedroom-2", x: 0.50, y: 0.60 }
          ]
        },
        {
          id: "bathroom",
          name: { en: "Bathroom", ru: "Ванная", hy: "Լոգարան" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/d7354a693_generated_image.png",
          hotspots: [
            { target_room_id: "hallway", x: 0.80, y: 0.50 }
          ]
        },
        {
          id: "hallway",
          name: { en: "Hallway", ru: "Коридор", hy: "Միջանցք" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/b098e99b6_generated_image.png",
          hotspots: [
            { target_room_id: "living-room", x: 0.50, y: 0.45 },
            { target_room_id: "bedroom-1", x: 0.30, y: 0.50 },
            { target_room_id: "bedroom-2", x: 0.70, y: 0.50 },
            { target_room_id: "bathroom", x: 0.85, y: 0.55 }
          ]
        },
        {
          id: "balcony",
          name: { en: "Balcony", ru: "Балкон", hy: "Պատշգամբ" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/453e67566_generated_image.png",
          hotspots: [
            { target_room_id: "living-room", x: 0.80, y: 0.50 }
          ]
        },
        {
          id: "exterior",
          name: { en: "Exterior", ru: "Снаружи", hy: "Արտաքին" },
          panorama_url: "https://media.base44.com/images/public/6a3414a8bdccd8048b972934/7fb6ae871_generated_image.png",
          hotspots: [
            { target_room_id: "living-room", x: 0.50, y: 0.50 }
          ]
        }
      ]
    },
