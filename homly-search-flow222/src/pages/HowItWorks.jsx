...
// ── Score counter hook ──
function useAnimatedScore(target, active) {
          ...
          <div>
            <div className="flex items-start justify-between gap-2">
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                {isBest && <Star size={11} fill="#8B6CFF" style={{ color: "#8B6CFF" }} />}
                <span
                  className="text-[13px] font-body font-bold"
                  style={{ color: isBest ? "#8B6CFF" : "#999999" }}
                >
                  {displayScore}%
                </span>
              </div>
            ...
            <div className="flex items-center gap-3 mt-1.5 text-[11px] font-body" style={{ color: "#999999" }}>
              <span className="flex items-center gap-1">
                <Bed size={10} style={{ color: "#8B6CFF" }} />
                {property.rooms} rooms
              </span>
              <span className="flex items-center gap-1">
                <Maximize2 size={10} style={{ color: "#8B6CFF" }} />
                {property.area} m²
              </span>
            </div>
          </div>
      ...
      {showReason && (
        ...
        >
          {property.reasons.map((r, ri) => (
            ...
            >
              <CheckCircle size={8} style={{ display: "inline", marginRight: 3, color: "#8B6CFF" }} />
              {r}
            </span>
          ))}
        </div>
          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5">
                {(t("howItWorksPage.criteriaChips") || criteriaChips).map((chip, i) => (
                  <span
                    key={chip}
      ...
      return (
        <div className="flex items-start gap-3">
          ...
          <div
            ...
            style={{ backgroundColor: "rgba(255,255,255,0.6)", border: "1px solid rgba(200,196,188,0.3)" }}
          >
            <div className="w-4 h-4 border-2 rounded-full animate-spin flex-shrink-0" style={{ borderColor: "rgba(139,108,255,0.2)", borderTopColor: "#8B6CFF" }} />
          ...
          {showExplanation && (
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-[10px] font-body font-semibold uppercase tracking-wider mb-1" style={{ color: "#8B6CFF" }}>
              ...
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[13px] font-body font-semibold" style={{ color: "#242424" }}>
                    ...
                    <span className="text-[10px] font-body font-semibold px-2 py-0.5 rounded-full" style={{ backgroundColor: "rgba(139,108,255,0.1)", color: "#8B6CFF" }}>
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-7 pt-5 pb-2 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/for-renters" className="text-[13px] font-body font-medium transition-opacity hover:opacity-60" style={{ color: "#666" }}>
            {t("common.rent")}
          </Link>
        ...
        <div className="mb-16">
          ...
          >
            ...
            <div className="flex" style={{ minHeight: "420px" }}>
              ...
              <div className="w-[230px] flex-shrink-0 border-r p-4 space-y-0.5" style={{ borderColor: "rgba(200,196,188,0.15)", backgroundColor: "rgba(255,255,255,0.3)" }}>
                  ...
                  {Array.from({ length: TOTAL_STEPS }).map((_, i) => (
                    <button
                      ...
                      style={{
                        ...
                        height: 5,
                        backgroundColor: i === activeStep ? "#8B6CFF" : "rgba(36,36,36,0.12)",
                      }}
                    />
                  ))}
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {steps.map((step, i) => (
              ...
              >
                ...
                >
                  <step.icon size={20} style={{ color: "#8B6CFF" }} />
                </div>
          ...
          <div className="grid grid-cols-2 gap-6 max-w-[720px] mx-auto">
            ...
            >
              ...
              <ul className="space-y-3">
                {(t("howItWorksPage.traditionalItems") || comparison.traditional).map((item, i) => (
            ...
            >
              ...
              <ul className="space-y-3">
                {(t("howItWorksPage.homlyItems") || comparison.homly).map((item, i) => (
                  <li key={i} className="flex items-start gap-2">
