...
const dashColors = ["#22C55E", "#8B6CFF", "#8B6CFF", "#8B6CFF", "#8B6CFF", "#8B6CFF"];
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-7 pt-5 pb-2 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/for-owners" className="text-[13px] font-body font-semibold transition-opacity hover:opacity-60" style={{ color: "#8B6CFF" }}>
            {t("common.owners")}
          </Link>
          <Link
            to="/list-property"
      ...
      <div className="max-w-5xl mx-auto px-6 pb-20">
        ...
        <div className="text-center pt-12 pb-10">
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            <Link
              to="/list-property"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-[15px] font-body font-semibold transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5"
              style={{ backgroundColor: "#8B6CFF", color: "#FFF" }}
            >
              {t("forOwnersPage.cta")}
              <ArrowRight size={16} />
            ...
            <Link
              to="/how-it-works"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-[15px] font-body font-medium transition-all duration-200 hover:shadow-md"
              style={{
                ...
                {demoTitles.map((step, i) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor: i <= activeDemoStep ? "rgba(139,108,255,0.1)" : "rgba(36,36,36,0.04)",
                      }}
                    >
                      <step.icon
                        size={22}
                        style={{ color: i <= activeDemoStep ? "#8B6CFF" : "#BBBBBB" }}
                      />
                    </div>
                    <div className="flex flex-col items-center gap-0.5">
                      {i > 0 && (
                        <div
                          ...
                          style={{
                            backgroundColor: i <= activeDemoStep ? "rgba(139,108,255,0.3)" : "rgba(36,36,36,0.06)",
                            position: "absolute",
                            left: "-20px",
                            top: "50%",
                          }}
                    ...
                    {i <= activeDemoStep && i === activeDemoStep && (
                      <span className="text-[9px] font-body font-semibold px-1.5 py-0.5 rounded-full" style={{ backgroundColor: "rgba(139,108,255,0.1)", color: "#8B6CFF" }}>
                        {t("forOwnersPage.now")}
                        </span>
                    )}
                  </div>
                  ...
                  {demoTitles.map((_, i) => (
                    <button
                      ...
                      style={{
                        ...
                        height: 5,
                        backgroundColor: i === activeDemoStep ? "#8B6CFF" : "rgba(36,36,36,0.12)",
                      }}
                    />
                  ))}
                </div>
          ...
          >
            <div className="px-6 py-5 border-b" style={{ borderColor: "rgba(200,196,188,0.2)" }}>
              <div className="flex items-center gap-2">
                <Home size={16} style={{ color: "#8B6CFF" }} />
            ...
            <div className="p-6">
                ...
                {dashboardStats.map((stat, i) => (
                  ...
                  >
                    <div className="flex items-center gap-1.5 mb-2">
                      <stat.icon size={12} style={{ color: stat.color || "#8B6CFF" }} />
              ...
              >
                <div className="flex items-start gap-2">
                  <Sparkles size={14} style={{ color: "#8B6CFF", marginTop: 1 }} />
                  <div>
