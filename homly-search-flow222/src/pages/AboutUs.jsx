...
import ArmeniaOutline from "@/components/homly/ArmeniaOutline";
...
function FounderAvatar({ gradient }) {
  return (
    <div
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            style={{ backgroundColor: "rgba(139,108,255,0.08)", color: violet, border: "1px solid rgba(139,108,255,0.15)" }}
          >
            <Linkedin size={14} />
          </a>
          <a
...
function DifferentItem({ children }) {
  return (
...
function MissionCard({ number, title, description }) {
  return (
    <div
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-20 pb-16 space-y-16">
        ...
        <section className="text-center space-y-5">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <Link
              ...
              style={{ backgroundColor: violet, color: "#FFF", boxShadow: "0 4px 16px rgba(139,108,255,0.3)" }}
            >
        ...
        <section className="space-y-7">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <FounderCard
              avatarGradient="linear-gradient(135deg, #8B6CFF 0%, #B49EFF 100%)"
