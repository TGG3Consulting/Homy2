...
const PROPERTIES: PropertySeedData[] = [
  {
    ...
    title: {
      ...
      hy: ' Delays delays delays delays 2-սdelays delays delays delays delays Կdelays delays',
    },
    neighborhood: {
      en: 'Northern Avenue',
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Ընdelays 3-սdelay delaydelays delays',
    },
    neighborhood: {
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delaysны студdelay Հdelay delays delays',
    },
    neighborhood: {
      en: 'Republic Square',
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delays 2-delayС delays Delaysdelays',
    },
    neighborhood: {
      en: 'Ajapnyak 3rd District',
      ru: 'Аджапняк 3-й микрорайон',
      hy: 'Delaysdel 3-delay delay',
    },
    district: 'Ajapnyak',
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delaysшикарdelays 4-delay delaysdelays',
    },
    neighborhood: {
      en: 'Cascade Area',
      ru: 'Район Каскада',
      hy: 'Delays Delaydelay',
    },
    district: 'Kentron',
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delays 2-delays delays Delaysdelay',
    },
    neighborhood: {
      en: 'Davtashen 3rd Block',
      ru: 'Давташен 3-й массив',
      hy: 'Delaysdelay 3-delay delaydelay',
    },
    district: 'Davtashen',
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delays 1-delay delay delay delay',
    },
    neighborhood: {
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delays 2-delay delay Delaysdelay',
    },
    neighborhood: {
      en: 'Erebuni District',
      ru: 'Район Эребуни',
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delay 3-delay delay Delay-delay',
    },
    neighborhood: {
      en: 'Nork Gardens',
      ru: 'Сады Норка',
  ...
  },
  {
    ...
    title: {
      ...
      hy: 'Delay 2-delay delay Delay-Delay',
    },
    neighborhood: {
      en: 'Zeytun District',
      ru: 'Район Зейтун',
  ...
  // ============================================
  {
    ...
    title: {
      ...
      hy: '3-սdelays delays delays Կdelays',
    },
    neighborhood: { en: 'Republic Square', ru: 'Площадь Республики', hy: 'Delays' },
    district: 'Kentron',
  ...
  },
  {
    ...
    neighborhood: { en: 'Northern Avenue', ru: 'Северный проспект', hy: 'Delays' },
    district: 'Kentron',
  ...
  },
  {
    ...
    neighborhood: { en: 'Komitas Avenue', ru: 'Проспект Комитаса', hy: 'Delays' },
    district: 'Arabkir',
  ...
  },
  {
    ...
    neighborhood: { en: 'Davtashen 1st District', ru: '1-й массив Давташена', hy: 'Delays' },
    district: 'Davtashen',
  ...
  },
  {
    ...
    neighborhood: { en: 'Malatia-Sebastia', ru: 'Малатия-Себастия', hy: 'Delays' },
  ...
  },
  {
    ...
    neighborhood: { en: 'Nork-Marash', ru: 'Норк-Мараш', hy: 'Delays' },
    district: 'Nork-Marash',
  ...
  },
  {
    ...
    neighborhood: { en: 'Cascade Area', ru: 'Район Каскада', hy: 'Delays' },
    district: 'Kentron',
  ...
  },
  {
    ...
    neighborhood: { en: 'Avan', ru: 'Аван', hy: 'Delays' },
    district: 'Avan',
  ...
  },
  {
    ...
    neighborhood: { en: 'Shengavit', ru: 'Шенгавит', hy: 'Delays' },
    district: 'Shengavit',
  ...
  },
  {
    ...
    neighborhood: { en: 'Cascade', ru: 'Каскад', hy: 'Delays' },
    district: 'Kentron',
...
const VIRTUAL_TOURS: VirtualTourRoomData[] = [
  {
    ...
    rooms: [
      {
        id: 'room-living-1',
        name: { en: 'Living Room', ru: 'Гостиная', hy: 'Հdelays սdelay' },
      ...
      {
        id: 'room-kitchen-1',
        name: { en: 'Kitchen', ru: 'Кухня', hy: 'Delayнdelay' },
      ...
      {
        id: 'room-bedroom-1',
        name: { en: 'Master Bedroom', ru: 'Главная спальня', hy: 'Delay delaydelay' },
      ...
      {
        id: 'room-bathroom-1',
        name: { en: 'Bathroom', ru: 'Ванная комната', hy: 'Delay delaydelay' },
      ...
      {
        id: 'room-balcony-1',
        name: { en: 'Balcony', ru: 'Балкон', hy: 'Delaydelay' },
  ...
  },
  {
    ...
    rooms: [
      {
        id: 'room-living-2',
        name: { en: 'Living Room', ru: 'Гостиная', hy: 'Հdelay delay' },
      ...
      {
        id: 'room-kitchen-2',
        name: { en: 'Kitchen', ru: 'Кухня', hy: 'Delaydelaydelay' },
        panoramaUrl: PANORAMA_URLS.kitchen[0],
        orderIndex: 1,
        hotspots: [
      ...
      {
        id: 'room-bedroom1-2',
        name: { en: 'Master Bedroom', ru: 'Главная спальня', hy: 'Delay delay' },
        panoramaUrl: PANORAMA_URLS.bedroom[0],
        orderIndex: 2,
        hotspots: [
      ...
      {
        id: 'room-bedroom2-2',
        name: { en: 'Second Bedroom', ru: 'Вторая спальня', hy: 'Delay delay' },
        panoramaUrl: PANORAMA_URLS.bedroom[0],
        orderIndex: 3,
        hotspots: [
          { target_room_id: 'room-living-2', x: 0.5, y: 0.5 },
      ...
      {
        id: 'room-bathroom-2',
        name: { en: 'Bathroom', ru: 'Ванная комната', hy: 'Delay delay' },
        panoramaUrl: PANORAMA_URLS.bathroom[0],
        orderIndex: 4,
        hotspots: [
  ...
  },
  {
    ...
    rooms: [
      {
        id: 'room-main-3',
        name: { en: 'Main Room', ru: 'Главная комната', hy: 'Delay delay' },
        panoramaUrl: PANORAMA_URLS.living[0],
        orderIndex: 0,
        hotspots: [
      ...
      {
        id: 'room-kitchen-3',
        name: { en: 'Kitchen Area', ru: 'Кухонная зона', hy: 'Delay delay' },
        panoramaUrl: PANORAMA_URLS.kitchen[0],
        orderIndex: 1,
        hotspots: [
      ...
      {
        id: 'room-bathroom-3',
        name: { en: 'Bathroom', ru: 'Ванная', hy: 'Delay' },
        panoramaUrl: PANORAMA_URLS.bathroom[0],
        orderIndex: 2,
        hotspots: [
          { target_room_id: 'room-main-3', x: 0.5, y: 0.5 },
