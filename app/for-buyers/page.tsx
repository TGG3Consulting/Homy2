    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-4 md:px-7 pt-4 md:pt-5 pb-2 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          <Link href="/how-it-works" className="hidden md:block text-[13px] font-body font-medium transition-opacity hover:opacity-60" style={{ color: "#666" }}>
            {t("common.howItWorks")}
          </Link>
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 pb-16 md:pb-20">
        {/* ── Hero ── */}
        <div className="text-center pt-10 md:pt-14 pb-10 md:pb-12">
          <h1
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-6">
            <Link
              href="/"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-6 py-2.5 rounded-full text-[14px] font-body font-semibold transition-all duration-200 hover:shadow-md"
              style={{ backgroundColor: "#0A6045", color: "#FFF" }}
            >
              {t("forBuyersPage.cta")}
              <ArrowRight size={15} />
            ...
            <Link
              href="/how-it-works"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-6 py-2.5 rounded-full text-[14px] font-body font-semibold transition-all duration-200 hover:opacity-70"
              style={{
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f, i) => (
              ...
              >
                ...
                >
                  <f.icon size={18} style={{ color: "#0A6045" }} />
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {deepFeatures.map((f, i) => (
              <div
                ...
                className="rounded-2xl p-5 transition-all duration-300 hover:-translate-y-1"
                style={{
                  backgroundColor: "rgba(10, 96, 69,0.03)",
                  backdropFilter: "blur(12px)",
                  border: "1px solid rgba(10, 96, 69,0.1)",
                  boxShadow: "0 2px 12px rgba(0,0,0,0.02), inset 0 1px 0 rgba(255,255,255,0.8)",
                }}
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3" style={{ backgroundColor: "rgba(10, 96, 69,0.08)" }}>
                  <f.icon size={18} style={{ color: "#0A6045" }} />
                </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-[720px] mx-auto">
            ...
            <div
              className="rounded-2xl p-6"
              style={{ backgroundColor: "rgba(10, 96, 69,0.04)", border: "1px solid rgba(10, 96, 69,0.15)", boxShadow: "0 0 0 2px rgba(10, 96, 69,0.03)" }}
            >
              <p className="text-[12px] font-body font-semibold uppercase tracking-wider mb-4" style={{ color: "#0A6045" }}>{t("forBuyersPage.homlyLabel")}</p>
              <ul className="space-y-3">
